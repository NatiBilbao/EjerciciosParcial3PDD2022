...
public class InstalacionAlcantarillado implements IEmpresas {
    ...
    public InstalacionAlcantarillado(ITipoPago tipoPago, String nombre, int nit, int numAutorizacion, double precio){
